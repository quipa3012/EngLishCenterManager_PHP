            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="course_list.php" class="btn-get-started scrollto">Tìm Hiểu Ngay</a>
                    </div>
                </div>
                ...
                if ($course_list !== 0) {
                    while ($result = $course_list->fetch_assoc()) {
                        ...
                        <div class="col-lg-5 col-sm-5 mt-5 course-box section-title">
                            ...
                            <a href="course_detail.php?CourseID=<?php echo $result['CourseID'] ?>"
                                class="course-edit-button mt-3" type="submit" style="margin: auto 20px;">Chi Tiết Khóa Học</a>
                        </div>
                        <?php
                    }
                }
